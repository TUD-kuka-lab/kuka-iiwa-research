...
namespace iiwa_tools {
    ...
    void IiwaService::_load_params()
    {
        ...
        //std::cout << "\n\nLooking for robot desc in: " << myns + "/service/robot_description" << "\n\n";

        n_p.param<std::string>(myns+"/service/robot_description", _robot_description, "/robot_description");
        n_p.param<std::string>(myns+"/service/end_effector", _end_effector, "iiwa_link_ee");
        n_p.param<std::string>(myns+"/service/fk_service_name", _fk_service_name, "iiwa_fk_server");
        n_p.param<std::string>(myns+"/service/ik_service_name", _ik_service_name, "iiwa_ik_server");
        n_p.param<std::string>(myns+"/service/jacobian_service_name", _jacobian_service_name, "iiwa_jacobian_server");
        n_p.param<std::string>(myns+"/service/jacobian_deriv_service_name", _jacobian_deriv_service_name, "iiwa_jacobian_deriv_server");
        n_p.param<std::string>(myns+"/service/jacobians_service_name", _jacobians_service_name, "iiwa_jacobians_server");
        n_p.param<std::string>(myns+"/service/gravity_service_name", _gravity_service_name, "iiwa_gravity_server");
    }
