...
namespace iiwa_gazebo {
        ...
        std::vector<transmission_interface::TransmissionInfo> transmissions)
    {
        ...
        std::string robot_ns = model_nh.getNamespace();
        //std::cout << "\n\nLooking for gravity at: " << robot_ns + "/iiwa_gravity_server"<< "\n\n";
        _iiwa_gravity_client = model_nh.serviceClient<iiwa_tools::GetGravity>(robot_ns + "/iiwa_gravity_server");
